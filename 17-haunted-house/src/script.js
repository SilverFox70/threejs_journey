...
// Height of the walls plus 1/2 of cone height
...
renderer.setSize(sizes.width, sizes.height)
renderer.setPixelRatio(Math.min(window.devicePixelRatio, 2))
// Set ClearColor to match fog so it blends seamlessly
...
const tick = () =>
{
    ...
    ghost3.position.z = Math.sin(ghost3Angle) * (7 + Math.sin(elapsedTime * 0.50));
